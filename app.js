...
async function setup() {
  ...
  const survey_one_q4    = await Survey_Q.create({survey_id: 1, question_id: 3, prompt: "What is your favorite number from 5-10?", type: "range", top_range: 10, bottom_range: 5})
  ...
  const survey_one_q6    = await Survey_Q.create({survey_id: 1, question_id: 5, prompt: "Can you see the following image",img: "FMS/DeepSquat.png", type: "one"})
  ...
  const h2f_q1    = await Survey_Q.create({survey_id: 2, question_id: 1, prompt: "How long should you cool down after a workout?", type: "one", point_value: 1})
  ...
  const h2f_q2    = await Survey_Q.create({survey_id: 2, question_id: 2, prompt: "All of the following can be results of doing a proper cool down after exercise EXCEPT:", type: "one", point_value: 1})
  ...
  const h2f_q3    = await Survey_Q.create({survey_id: 2, question_id: 3, prompt: "Which of the following is not a food group:", type: "one", point_value: 1})
  ...
  const h2f_q4    = await Survey_Q.create({survey_id: 2, question_id: 4, prompt: "All of the following are examples of whole grains except:", type: "one", point_value: 1})
  ...
  const h2f_q5    = await Survey_Q.create({survey_id: 2, question_id: 5, prompt: "The ability to sense other people's emotions is known as:", type: "one", point_value: 1})
  ...
  const h2f_q6    = await Survey_Q.create({survey_id: 2, question_id: 6, prompt: "The ability to sort through irrelevant information and thoughts to concentrate and focus on a specific task is known as:", type: "one", point_value: 1})
  ...
  const h2f_q7    = await Survey_Q.create({survey_id: 2, question_id: 7, prompt: "The idea of learning how to be fully present and engaged in moment and aware of your thoughts and feelings without distraction or judgment is:", type: "one", point_value: 1})
  ...
  const h2f_q8    = await Survey_Q.create({survey_id: 2, question_id: 8, prompt: "The process of two people or groups in a conflict agreeing to make amends or come to a truce is known as:", type: "one", point_value: 1})
  ...
  const h2f_q9    = await Survey_Q.create({survey_id: 2, question_id: 9, prompt: "Adults need at least how many hours of sleep per night?", type: "one", point_value: 1})
  ...
  const h2f_q10    = await Survey_Q.create({survey_id: 2, question_id: 10, prompt: "Being awake for more than 20 hours results in an impairment equal to a blood alcohol level of 0.08%.", type: "one", point_value: 1})
  ...
  const cpa_q1    = await Survey_Q.create({survey_id: 3, question_id: 1, header: "Motivation to live a healthy lifestyle in each category", prompt: "M- Physical Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q1_a1 = await Survey_A.create({survey_id: 3, question_id: 1, answer_id: 1, text: "number"})
  const cpa_q2    = await Survey_Q.create({survey_id: 3, question_id: 2, prompt: "M- Mental Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q2_a1 = await Survey_A.create({survey_id: 3, question_id: 2, answer_id: 1, text: "number"})
  const cpa_q3    = await Survey_Q.create({survey_id: 3, question_id: 3, prompt: "M- Nutritional Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q3_a1 = await Survey_A.create({survey_id: 3, question_id: 3, answer_id: 1, text: "number"})
  const cpa_q4    = await Survey_Q.create({survey_id: 3, question_id: 4, prompt: "M- Spiritual Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q4_a1 = await Survey_A.create({survey_id: 3, question_id: 4, answer_id: 1, text: "number"})
  const cpa_q5    = await Survey_Q.create({survey_id: 3, question_id: 5, prompt: "M- Sleep Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q5_a1 = await Survey_A.create({survey_id: 3, question_id: 5, answer_id: 1, text: "number"})

  const cpa_q6     = await Survey_Q.create({survey_id: 3, question_id: 6, header: "Ability to live a healthy lifestyle in each category", prompt: "A- Physical Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q6_a1  = await Survey_A.create({survey_id: 3, question_id: 6, answer_id: 1, text: "number"})
  const cpa_q7     = await Survey_Q.create({survey_id: 3, question_id: 7, prompt: "A- Mental Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q7_a1  = await Survey_A.create({survey_id: 3, question_id: 7, answer_id: 1, text: "number"}) 
  const cpa_q8     = await Survey_Q.create({survey_id: 3, question_id: 8, prompt: "A- Nutritional Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q8_a1  = await Survey_A.create({survey_id: 3, question_id: 8, answer_id: 1, text: "number"})
  const cpa_q9     = await Survey_Q.create({survey_id: 3, question_id: 9, prompt: "A- Spiritual Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q9_a1  = await Survey_A.create({survey_id: 3, question_id: 9, answer_id: 1, text: "number"})
  const cpa_q10    = await Survey_Q.create({survey_id: 3, question_id: 10, prompt: "A- Sleep Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q10_a1 = await Survey_A.create({survey_id: 3, question_id: 10, answer_id: 1, text: "number"})
  
  const cpa_q11    = await Survey_Q.create({survey_id: 3, question_id: 11, header: "Current (past 7 days) in each category", prompt: "C- Physical Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q11_a1 = await Survey_A.create({survey_id: 3, question_id: 11, answer_id: 1, text: "number"})
  const cpa_q12    = await Survey_Q.create({survey_id: 3, question_id: 12, prompt: "C-Mental Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q12_a1 = await Survey_A.create({survey_id: 3, question_id: 12, answer_id: 1, text: "number"})
  const cpa_q13    = await Survey_Q.create({survey_id: 3, question_id: 13, prompt: "C-Nutritional Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q13_a1 = await Survey_A.create({survey_id: 3, question_id: 13, answer_id: 1, text: "number"})
  const cpa_q14    = await Survey_Q.create({survey_id: 3, question_id: 14, prompt: "C-Spiritual Health: ", type: "range", top_range: 10, bottom_range: 1})
  const cpa_q14_a1 = await Survey_A.create({survey_id: 3, question_id: 14, answer_id: 1, text: "number"})
  const cpa_q15    = await Survey_Q.create({survey_id: 3, question_id: 15, prompt: "C-Sleep Health: ", type: "range", top_range: 10, bottom_range: 1})
  ...
  const fms_q2    = await Survey_Q.create({survey_id: 4, question_id: 2, prompt: "Enter Athlete's Score for Deep Squat: ",img: "FMS/DeepSquat.png", type: "range", bottom_range: 0, top_range: 3})
  const fms_q2_a1 = await Survey_A.create({survey_id: 4, question_id: 2, answer_id: 1, text: "3"})
  const fms_q3    = await Survey_Q.create({survey_id: 4, question_id: 3, prompt: "Enter Athlete's Score for Hurdle Step: ",img: "FMS/HurdleStep.png", type: "range", bottom_range: 0, top_range: 3})
  const fms_q3_a1 = await Survey_A.create({survey_id: 4, question_id: 3, answer_id: 1, text: "3"})
  const fms_q4    = await Survey_Q.create({survey_id: 4, question_id: 4, prompt: "Enter Athlete's Score for Inline Lunge: ",img: "FMS/InlineLunge.png", type: "range", bottom_range: 0, top_range: 3})
  const fms_q4_a1 = await Survey_A.create({survey_id: 4, question_id: 4, answer_id: 1, text: "3"})
  const fms_q5    = await Survey_Q.create({survey_id: 4, question_id: 5, prompt: "Enter Athlete's Score for Shoulder Mobility: ",img: "FMS/ShoulderMobility.png", type: "range", bottom_range: 0, top_range: 3})
  const fms_q5_a1 = await Survey_A.create({survey_id: 4, question_id: 5, answer_id: 1, text: "3"})
  const fms_q6    = await Survey_Q.create({survey_id: 4, question_id: 6, prompt: "Enter Athlete's Score for Active Straight Leg Raise: ",img: "FMS/ActiveStraightLegRaise.png", type: "range", bottom_range: 0, top_range: 3})
  const fms_q6_a1 = await Survey_A.create({survey_id: 4, question_id: 6, answer_id: 1, text: "3"})
  const fms_q7    = await Survey_Q.create({survey_id: 4, question_id: 7, prompt: "Enter Athlete's Score for Trunk Stability Push-Up: ",img: "FMS/TrunkStabilityPushup.png", type: "range", bottom_range: 0, top_range: 3})
  const fms_q7_a1 = await Survey_A.create({survey_id: 4, question_id: 7, answer_id: 1, text: "3"})
  const fms_q8    = await Survey_Q.create({survey_id: 4, question_id: 8, prompt: "Enter Athlete's Score for Rotary Stability: ",img: "FMS/RotaryStability.png", type: "range", bottom_range: 0, top_range: 3})
