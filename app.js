...
async function setup() {
  ...
  const notification1 = await Notification.create({notification_id: 1, unit: "1st", core_assessment_id: 1, category: "Physical", description: "You have scores significantly lower than your peers in the Physical domain of the assessment specified above. Please contact your unit's physical therapist to schedule a consultation."})
  const notification2 = await Notification.create({notification_id: 2, unit: "1st", core_assessment_id: 1, category: "Nutrition",description: "You have scores significantly lower than your peers in the Nutrition domain of the assessment specified above. Please contact your unit's nutritionist to schedule a consultation."})
  const notification3 = await Notification.create({notification_id: 3, unit: "1st", core_assessment_id: 1, category: "Spiritual",description: "You have scores significantly lower than your peers in the Spiritual domain of the assessment specified above. Please contact your unit's Spiritul Specialist to schedule a consultation."})
  const notification4 = await Notification.create({notification_id: 4, unit: "1st", core_assessment_id: 1, category: "Mental",description: "You have scores significantly lower than your peers in the Mental domain of the assessment specified above. Please contact your unit's mental health specialist to schedule a consultation."})
  const notification5 = await Notification.create({notification_id: 5, unit: "1st", core_assessment_id: 1, category: "Sleep",description: "You have scores significantly lower than your peers in the Sleep domain of the assessment specified above. Please contact your unit's sleep specialist to schedule a consultation."})

  const notification6 = await Notification.create({notification_id: 6, unit: "1st", core_assessment_id: 2, category: "Motivation",description: "You have scores significantly lower than your peers in the Motivation domain of the assessment specified above. Please contact your unit's therapist to schedule a consultation."})
  const notification7 = await Notification.create({notification_id: 7, unit: "1st", core_assessment_id: 2, category: "Ability",description: "You have scores significantly lower than your peers in the Ability domain of the assessment specified above. Please contact your unit's physical therapist to schedule a consultation."})
  const notification8 = await Notification.create({notification_id: 8, unit: "1st", core_assessment_id: 2, category: "Current",description: "You have scores significantly lower than your peers in the Current domain of the assessment specified above. Please contact your unit's therapist to schedule a consultation."})

  const notification9 = await Notification.create({notification_id: 9,   unit: "1st", core_assessment_id: 3, category: "PT", description: "You have score a 0 on a specifc exercise within the assessment specified above. Please contact your unit's physical therapist at jane.doe@army.mil to schedule a consultation."})
  const notification10 = await Notification.create({notification_id: 10, unit: "1st", core_assessment_id: 3, category: "MFT", description: "You have score a 1 on a specifc exercise within the assessment specified above. Please contact your unit's master fitness trainer at john.smith@army.mil to schedule a consultation."})
